<div class="bg-gray-100 py-10">
    ...
    <div class="max-w-7xl mx-auto">
        <form
            wire:submit.prevent='readFormData'
        >
            <div class="md:grid md:grid-cols-3 gap-5">
                <div class="mb-5">
                    <label 
                        class="block mb-1 text-sm text-gray-700 uppercase font-bold "
                        for="termino">Búsqueda
                    </label>
                    <input 
                        wire:model="search"
                        id="termino"
                        type="text"
                        placeholder="título, palabra clave: ej. Laravel"
                ...
                <div class="mb-5">
                    <label class="block mb-1 text-sm text-gray-700 uppercase font-bold">&nbsp;</label>
                    <div class="flex justify-items-start">
                        <input 
                            type="submit"
                            class="bg-indigo-500 hover:bg-indigo-600 transition-colors text-white font-bold px-10 py-2 rounded cursor-pointer uppercase w-full md:w-auto"
                            value="Buscar"
                        />
                    </div>
                </div>
